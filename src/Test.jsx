...
export default function Test({
  ...
  const handleClick = (inputType) => {
    ...
    // if (inputType === "valueOne") setCountOne((prevCount) => prevCount - 1);
    if (inputType === valueTwo) setCountOne((prevCount) => prevCount - 1);
    if (inputType === valueThree) setCountTwo((prevCount) => prevCount - 1);
    // if (inputType === "valueFour") setCountFour((prevCount) => prevCount - 1);
  };
  ...
  return (
    <div>
      <div className="">
        <label
          htmlFor="my-modal-4"
          className={`modal-button btn whitespace-nowrap rounded-full border-transparent  bg-${color}-600 font-bold normal-case text-white
           hover:bg-${color}-800`}
          data-bs-toggle="collapse"
          data-bs-target={`#${collapze}`}
        >
          {" "}
          Select Reward
        </label>
      ...
      <label htmlFor="my-modal-4" className="modal cursor-pointer">
        ...
        >
                ...
                <div class="card-body">
                  <div className="flex justify-between">
                    ...
                    <label
                      ...
                      className="btn whitespace-nowrap rounded-full border-transparent  bg-teal-600 font-bold normal-case text-white
         hover:bg-teal-800 "
                      onClick={() => handleClick(valueThree)}
         ...
         hover:bg-teal-800"
            ...
            <div class="card my-4">
              <div
                class="card-header h-[154px] cursor-text bg-white"
                id="headingFour "
              >
                <div className="pointer-events-none mt-2 flex justify-between opacity-50">
                  <h3
                    class=" font-bold hover:text-teal-600"
                    type="button"
                    data-bs-toggle="collapse"
